-- HOTFIX 3: Drop and recreate catalog_search_gemstones with correct types
-- Fixes: price_currency type mismatch (text -> currency_code)

-- Step 1: Drop existing function
DROP FUNCTION IF EXISTS catalog_search_gemstones(
  text, integer, integer, text[], text[], text[], text[], text[],
  integer, integer, numeric, numeric, boolean, boolean, boolean,
  text[], text[], text[], boolean, numeric, numeric, numeric, numeric,
