-- Add custom gemstone fields to gemstones_enriched view
-- These fields support the Professional Specifications and Treatment Disclosure components
-- FLEX-C3.1, FLEX-C3.2
...
COMMENT ON VIEW gemstones_enriched IS 'Enriched gemstone view with AI content, cuts table data, custom fields, and media counts';
