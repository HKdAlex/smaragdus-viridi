...
### **Minor: Client-Side DB Access**
**Issue:** `getFuzzySuggestions` calls `supabaseAdmin` from client  
**Impact:** "Did you mean?" banner doesn't show (but fuzzy search works!)  
**Solution:** Create `/api/search/fuzzy-suggestions` endpoint  
