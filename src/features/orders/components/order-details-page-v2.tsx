...
export function OrderDetailsPageV2({
  orderId,
  locale,
  isAdmin = false,
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              <Badge
                ...
                className={`flex items-center gap-2 px-3 py-1 ${getOrderStatusColors(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <CardContent className="space-y-6">
                {order.items?.map((item, index) => (
                  <div key={item.id} className="group">
                    <div className="flex gap-6 p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:border-white/20 transition-all duration-200 hover:shadow-lg hover:bg-white/10">
                      {/* Enhanced Gemstone Image */}
                      <div className="relative w-24 h-24 bg-muted rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden group-hover:scale-105 transition-transform duration-200">
          ...
          <div className="space-y-8">
            ...
            <Card className="border border-white/10 shadow-xl bg-white/5 backdrop-blur-md bg-gradient-to-br from-white/10 to-white/5 sticky top-24">
              <CardHeader>
                <CardTitle className="flex items-center gap-3 text-xl">
