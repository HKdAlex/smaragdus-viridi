  ...
  public: {
    Tables: {
      ...
      gemstone_individual_stones: {
        ...
        Relationships: [
          {
            foreignKeyName: "gemstone_individual_stones_gemstone_id_fkey"
            columns: ["gemstone_id"]
            isOneToOne: false
            referencedRelation: "gemstones"
            referencedColumns: ["id"]
    ...
    Views: {
      gemstones_enriched: {
        Row: {
          ...
          origin_id: string | null
          premium_price_amount: number | null
          premium_price_currency: string | null
    ...
    Functions: {
      ...
      upsert_gemstone_individual_stones: {
        Args: { p_gemstone_id: string; p_stones: Json }
        Returns: undefined
      }
      validate_cart_item: {
