      ...
      case "pear":
        return (
          <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
            ...
            />
            <path
              d="M12 6 C10 6, 8 8, 8 10 C8 12, 10 14, 12 16 C14 14, 16 12, 16 10 C16 8, 14 6, 12 6 Z"
              fill="currentColor"
              fillOpacity="0.4"
            />
      ...
      case "cushion":
        return (
          <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
            ...
            />
            <path
              d="M10 10 C10 10, 10 14, 10 14 C10 14, 14 14, 14 14 C14 14, 14 10, 14 10 C14 10, 10 10, 10 10 Z"
              fill="currentColor"
              fillOpacity="0.4"
            />
            <circle cx="12" cy="12" r="1.5" fill="currentColor" />
      ...
      case "radiant":
        return (
          <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
            ...
            />
            <path
              d="M12 8 L14 10 L14 14 L12 16 L10 14 L10 10 Z"
              fill="currentColor"
              fillOpacity="0.4"
            />
            <circle cx="12" cy="12" r="1.5" fill="currentColor" />
